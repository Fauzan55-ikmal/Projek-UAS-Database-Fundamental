...
('Fauzan Fauzia Fauzi', '082198765432', 'fauzanfauziafauzi@gmail.com', 'Cililin, Bandung'),
('Udin Berlin', '085711223344', 'asepberlin12@tedc.ac.id', 'Lembang, Bandung');

-- Memasukkan 3 Data Master Armada Awal
INSERT INTO armadas (model, capacity, status) VALUES
('Toyota Hiace', 14, 'active'),
('Isuzu Elf', 19, 'active'),
('Toyota Hiace Premio', 11, 'maintenance');

-- Memasukkan 3 Data Master Rute Awal
INSERT INTO routes (departure_city, arrival_city, duration) VALUES
('Bandung', 'Jakarta', '02:30:00'),
('Bandung', 'Yogyakarta', '08:00:00'),
('Bandung', 'Semarang', '06:30:00');

-- Memasukkan 3 Data Jadwal Awal
INSERT INTO schedules (departure_date, departure_time, price) VALUES
('2026-07-20', '07:00:00', 160000.00),
('2026-07-20', '14:00:00', 160000.00),
('2026-07-21', '08:00:00', 365000.00);

-- Memasukkan 3 Data Booking Awal
INSERT INTO bookings (booking_code, total_amount, payment_status) VALUES
('TRX-20260001', 320000.00, 'pending'),
('TRX-20260002', 365000.00, 'paid'),
('TRX-20260003', 290000.00, 'pending');
